...
//		server = getAppiumServerDefault(); // -> If using Windows, uncomment this statement and comment above statement
	...
	public void afterSuite() {
		  if(server.isRunning()){
			  server.stop();
			  //if using mac and if you to stop appium server manually then hit the below command :
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH", "your_complete_path_address" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "your_AANDROID_HOME_path");
